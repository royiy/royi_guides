# מדריך 6: Matrix Strategy ובדיקות מקבילות

> מדריך 6 מתוך 10 בסדרת המדריכים המקיפה ל-GitHub Actions בעברית.

## תוכן עניינים

1. [מהו Matrix Strategy](#מהו-matrix-strategy)
2. [מטריצה בסיסית](#מטריצה-בסיסית)
3. [Include ו-Exclude](#include-ו-exclude)
4. [שליטה בקצב הריצה](#שליטה-בקצב-הריצה)
5. [fail-fast וההשלכות שלו](#fail-fast-וההשלכות-שלו)
6. [מטריצה דינמית מתוך JSON](#מטריצה-דינמית-מתוך-json)
7. [מטריצה מרובת ממדים - דוגמה מקיפה](#מטריצה-מרובת-ממדים---דוגמה-מקיפה)
