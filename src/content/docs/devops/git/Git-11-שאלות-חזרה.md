...
שאלות חזרה אינטראקטיביות על כל מה שלמדתם לאורך מדריכי ה-Git (מבוא, ענפים ומיזוג, ביטול שינויים, Stash/Cherry-Pick, Remotes, Workflows, Internals, Hooks ואבטחה). בחרו תשובה בכל שאלה ותקבלו מיד משוב האם היא נכונה, יחד עם הסבר.
