...
Terraform הוא כלי **Infrastructure as Code (IaC)** בקוד פתוח שפותח על ידי חברת HashiCorp. הוא מאפשר לכם להגדיר תשתית ענן (ומקומית) בקבצי תצורה קריאים לבני אדם, לגרסא אותם, לשתף אותם עם הצוות ולנהל את מחזור החיים המלא של התשתית - יצירה, עדכון ומחיקה - בצורה עקבית וניתנת לחיזוי.
