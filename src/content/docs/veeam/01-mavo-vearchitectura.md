...
Veeam היא אחת מפלטפורמות הגיבוי וה-DR (Disaster Recovery) הנפוצות ביותר בעולם הארגוני. ידע ב-Veeam נדרש כמעט בכל תפקיד של מנהל מערכות (SysAdmin), מהנדס תשתיות, ו-DevOps, ולכן היכרות מעמיקה עם המוצר משפרת משמעותית סיכויי קבלה למשרות IT.
...
ממשק הניהול - יכול להיות מותקן על אותו שרת או על תחנת עבודה נפרדת שמתחברת לשרת הגיבוי. קיים גם **Veeam Web UI** לניהול מהדפדפן ללא קונסולה עבה.
...
**ש: האם אפשר להתקין את כל הרכיבים על שרת אחד?**
...
ת: גרסה חינמית עם הגבלות (עד 10 מכונות/עומסים), מצוינת ללימוד ותרגול.
